...
const MEDS = [
  ...
  {id:"lexapro",brandName:"Lexapro",genericName:"escitalopram",
   ...
   overseasUses:"Approved everywhere else for Social Anxiety Disorder and Panic Disorder with or without Agoraphobia. Also OCD in Australia, Canada, Argentina, Chile, Denmark, Sweden, Spain, New Zealand, and the UK.",
   offLabelUses:["Social anxiety disorder","OCD","PTSD","Panic disorder","Bipolar depression"],
   onset:"Can start working within one week — give it at least three weeks unless side effects hit hard and fast. About a 60-75% chance of response and 50-70% chance of remission for MDD. Lexapro and Celexa both beat other SSRIs for MDD effectiveness.",
   dosage:"Manufacturer recommends 10mg once a day. Crazymeds suggests starting at 5mg, increasing by 2.5-5mg after at least a week, only if needed.",
   howToStop:"Decrease by 5mg every week. On 10mg? Take 5mg for a week, then stop. Try 2.5mg if needed.",
  ...
  {id:"zoloft",brandName:"Zoloft",genericName:"sertraline",
   ...
   offLabelUses:["GAD (mixed results, which probably explains why Zoloft was never approved for it)","Depression with cardiovascular conditions (SADHART trial: clever acronym, but Zoloft did not really help all that much)","Eating disorders: binge eating, bulimia, anorexia, sleep eating","Menopause/hot flashes (equal chance of helping, worsening, or doing absolutely nothing)"],
   onset:"Anywhere from a couple days to over a month. You should feel more awake and energetic within 2-4 days. Better for anxiety spectrum than depression spectrum — which is funny given how agitated and nervous it makes a lot of people feel. Works well for depression defined by sleeping too much, eating too much, and withdrawing from the world.",
  ...
  {id:"cymbalta",brandName:"Cymbalta",genericName:"duloxetine",
   ...
   offLabelUses:["Stress urinary incontinence (women and possibly men)","ADD/ADHD","Smoking cessation","Migraines and other headaches"],
   onset:"Psychiatric: 3 days to a month, average about two weeks. For fibromyalgia — who the fuck knows. Even opioids may as well be placebos for a lot of people, and those folks are the Crazymeds demographic. SNRIs are far less likely to poop-out than SSRIs.",
   dosage:"MDD: start 40-60mg/day in 1-2 doses, target 60mg, max 120mg. GAD: start 60mg once a day, max 120mg. Crazymeds suggests starting at 20mg and increasing by 20mg as needed. Consider twice daily due to the short half-life.",
   howToStop:"The manufacturer says taper gradually and that is literally it. Helpful. Crazymeds says: 10-20mg/week. Cymbalta comes in 20, 30, and 60mg capsules. Do the math. If discontinuation symptoms do not go away, ask for a Prozac prescription.",
   halfLife:"12 hours."},
...
const ARTICLES = [
  ...
  {id:"about",title:"About Jerod Poore",subtitle:"Chief Citizen Medical Expert, AA, CME, QBE",
   sections:[
    {h:null,b:"Unlike practically all consumer/peer-run mental health sites, I am out in the open about being batshit crazy. I am treatment-resistant, so it is highly unlikely I will ever be able to hold a job. Which is OK, because I am such a cheap bastard I am able to live off of the ad revenue Crazy Meds generates. I live near the crossroads of No and Where Montana. Ted Kaczynski interacted with his neighbors more than I do."},
