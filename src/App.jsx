...
const ARTICLES = [
  ...
  {id:"should-you",title:"Should You Be Taking Psychiatric or Neurological Medications?",subtitle:"The Am I That Messed-Up? checklist",
   sections:[
    {h:null,b:"There is a huge paradox regarding neurological and psychiatric medications. Many people who need to take drugs cannot or will not because the stigma is too great, or they do not have the money. Yet there are also people who are needlessly taking meds thanks to Big Pharma's marketing campaigns and disease mongering — where they make up an illness where one did not previously exist, such as Cephalon's invention of Shift Work Sleep Disorder as a way to market Provigil and Nuvigil as expensive prescription substitutes for coffee. And there is always one study after another showing how antidepressants only work for those of us with severe depression. This is not helped by the use of certain assessment tools that are so likely to guarantee a drug's success in a clinical trial they can also make the placebo look far more effective than it actually is. I'm looking at you, MADRS."},
    {h:"Are You Now, or Have You Ever Been Crazy?",b:"There are a plethora of self-diagnosis tests available online. On official sites for medications you will often find ten-question, multiple-guess tests that are almost guaranteed to diagnose you as having whatever the med treats, so you can take a printout to your doctor to talk to your doctor about Fixitol (panacea HCl). There are perfectly normal behaviors that family and friends might consider indicators of mental illness. On the flip side there are also symptoms and behaviors that scream SEEK PROFESSIONAL HELP IMMEDIATELY. Whether or not you require meds is still yet to be determined."},
    {h:"Have You Been Diagnosed with Epilepsy?",b:"You need to take medication, or require other treatments that a neurologist deals with. If you have not been diagnosed but have had one or more seizures, you need to see a doctor. If you are not sure whether you had a seizure, the International League Against Epilepsy has videos explaining different seizure types. If you are anywhere from unsure to certain you had one or more seizures, you need to see a doctor."},
    {h:"Migraines or Other Severe Headaches?",b:"If you have not seen a doctor yet, make an appointment already. Migraines and other headaches can sometimes be treated with non-drug interventions: avoiding certain foods, lifestyle changes, even acupuncture. And some godawful headaches do not respond to any medication on the market for most people, so you are stuck with oxygen and something to knock you out. So maybe you do need to take medication and maybe you do not. Not everything can be figured out with a stupid little test like this."},
    {h:"Moderate-to-Severe Physical Pain?",b:"If you are experiencing pain that makes it difficult to function on a daily basis, is a symptom of what is generally considered a psychological problem such as depression, or has no obvious source — have you seen a neurologist yet? If not, why not? No, do not answer that. See one if you can. In all likelihood you will need meds. While pain is often a symptom of depression, depression can also be a symptom of pain-related neurological conditions."},
    {h:"Schizophrenia, Bipolar Disorder, or Schizoaffective Disorder?",b:"You need medication. Have you been taking medication and your symptoms are gone or are not as bad as they used to be? _That is because the meds are working._ If you still have symptoms, talk with your doctor about adjusting dosages or changing your meds. If your symptoms are gone, talk with your doctor about whether to lower dosages. Yes, remission is possible. If your symptoms have been completely gone for as long as your doctors think is long enough, talk with them about reducing your meds with the goal of not taking any. While it is possible to no longer need medication, be prepared to be disappointed. And always keep some on hand for emergencies. Getting a second opinion is an excellent idea. A third is not a bad idea. If all of them say you have one or more of those conditions, you have at least one of them and you need medication."},
    {h:"The Functionality Quiz",b:"Can you: get out of bed, get dressed, go to work and accomplish something beyond showing up and pretending to get some work done, feed the kids and other pets, do the laundry, make dinner (a bowl of cereal should not be considered dinner — although there are plenty of times when putting together a dinner as complex and nutritious as a bowl of cereal is a triumph over immense adversity, even without raisins), interact with other people who exist in the real world and not on teh interwebs, go shopping for groceries and other essentials (online shopping counts), otherwise leave your room whenever you want or need to without taking two hours making sure the door is locked or without the help of alcohol or some substance obtained without a prescription, not max out your credit cards buying materials for yet another life-changing project you will never finish, fall asleep without lying awake for hours being afraid of everything that can go wrong, or ruminating over everything that did go wrong, blaming yourself for things you had no control over, reliving them in vivid detail, over and over and over?"},
    {h:null,b:"If your life is a struggle or otherwise out of control, and you cannot make it through the day without somebody else taking care of the essentials most people can do themselves, you need medication and/or serious talk therapy. What you really need to do is get off the fucking Internet and make an appointment to see someone qualified to determine if you need meds, which ones, and prescribe them. The good news: for depression and anxiety-spectrum disorders, medication is usually temporary. At least it is supposed to be."},
    {h:"The Bipolar Irony",b:"It is especially ironic if you have a form of bipolar disorder with euphoric mania. You get to be ridiculed for taking expensive medications in order to not feel as if you have done a bunch of meth or cocaine, which are often cheaper than mood stabilizers, while people in rehab to recover from snorting cocaine and meth are lauded as heroic for overcoming their addictions. Usually by the same people who give us the most shit for taking meds to not feel the same way. We pay through the nose for drugs to NOT get high, and we are the assholes."},
    {h:"Do You Have Physical Symptoms?",b:"If and when you feel panicked or anxious, does your heart race? Do you breathe rapidly? Do you sweat? If and when you are depressed, do you feel cold to the touch? Pain for no reason? Do you actually need to sleep 11-14 or more hours a day? If and when you are super-irritable or on a shopping spree, do you feel warmer than usual, almost feverish? Do you move more quickly than normal? Are your senses heightened? If you answered yes to any of these, you need to see a doctor. You may or may not need meds now, but if you are manifesting physical symptoms it is bad enough to need some sort of regular treatment. Otherwise, you probably do not need meds. A self-help book or two and maybe a few lifestyle changes are all you need. Thanks for stopping by Crazymeds."},
  ]},
  ...
  {id:"talk-to-doctor",title:"How to Talk to Your Doctor",subtitle:"Making the most of 15-minute medication check-up appointments",
   sections:[
    {h:null,b:"This has nothing to do with talk therapy. You are on your own for that. This is about making the most of 15-minute medication check-up appointments with doctors. If you are lucky you will get 30 minutes."},
    {h:"Write a Script",b:"The best way to look at this is as if you are writing a script and the scene is in the doctor's office. But I am a bipolar writer, so expect the unrealistic. Think of it as whatever works for you: something that involves two people talking for 15-30 minutes, where you are doing most of the blabbing, or the first letter, email, or blog entry on the subject of your upcoming appointment. Back-of-the-envelope notes, while vastly better than nothing, do not have enough detail or order to make the most of a 15-minute appointment you get once every three months. The format is important to give you a sense of how much you have to cover in how little time. People get so worried about what they need to say they end up saying it at the end of the appointment, and doctors hate that. It is little wonder people get crap prescribed if they leave entirely new symptoms for the last-second just one more thing."},
    {h:"What Goes in the Script",b:"Say the most important stuff at the very beginning — generally that takes the form of: what sucks most? Although in many cases it can be: what has improved most! Be open and honest with yourself and your doctor. When you hide things from your doctor you get misdiagnosed. When you get misdiagnosed you get inappropriate treatments. When you get inappropriate treatments, that sucks donkey dong. And it can contribute to becoming treatment-resistant, where nothing works well, if at all. When you become treatment-resistant, that sucks syphilitic donkey dong. Try not to exaggerate. Be as concise as possible, but bring all your notes in case your doctor wants more information. You want to write for about one-third to one-half of however long your appointment is."},
    {h:"Keep Records",b:"You need to be keeping a record of the meds you take, if they work or not, and what the side effects are like. It does not need to be fancy, and it does not have to be daily. All you really need is: date, drug name and dosage, and event — starting or stopping a drug, changing the dosage, symptoms improving or getting worse, a new side effect, an existing side effect going away or coming back. You can keep this on a notepad, a blog, the backs of envelopes, tweets to your imaginary friends. How you record it is not particularly relevant, just as long as you can show it to your doctor."},
    {h:"Track Your Life, Not Just Your Meds",b:"In addition to meds you need to keep track of how your condition affects your life. Identify key areas: mood, anxiety, logical thought and follow-through, ability to handle daily tasks. Your key areas will vary. Input from other people is extremely helpful — you cannot judge how you act from inside of you on a lot of things. Trust me on this. You may think you are doing just fine on things that are a right mess. And when weird stuff just happens to you, anything that triggers you, that freaks you out, that sets you off, that causes anything nasty to happen — record that."},
    {h:"On Side Effects: Primal Screed",b:"When it comes to side effects, the general attitude at Crazymeds is: stop being such a baby and take your freakin medicine. When keeping a record of your side effects for talking with your doctor, go wild with side effect paranoia and complain, complain, complain. It is cathartic. Most people will blame the meds anyway, so write it down where nobody will see it unless they need to. Who knows what is or is not the first sign of something important? That crazy med really does make your ears ring! But when it comes time to write the script for your appointment, you need to be as rational as a crazy person can be about side effects. Get the opinions of other people who are not going to enable you into rationalizing the decision to stop taking a working medication."},
    {h:"The Doctor Works for You",b:"This may seem like a lot of work, but it is well worth it. Organizing your records will really help you understand what is going on in the healing process. Being in control of things is important. So many people feel so out of control during the entire process of trying to get their mental illness under control, and you cannot afford to be out of control. If you need to be taking meds you are managing the symptoms of conditions for which there are yet no cures. Whose responsibility is this illness? If you do something crazy-bad, crazy-bad enough to get arrested, who goes to jail, you or your doctor? The illness is not your fault, but it is your responsibility. You do not have to be pushed around. Remember, the doctors work for you. But good employees will sometimes require documentation before just going off and doing something. Take control, get organized, and keep taking your crazy meds."},
    {h:null,b:"What is it like to be crazy? Part of what it is like is being out of control all the time. What is it like to stop being crazy? To start taking control of your life."},
  ]},
  {id:"maois",title:"Monoamine Oxidase Inhibitors (MAOIs)",subtitle:"The original modern antidepressants — kept from wider use by being old and a pain in the ass",
   sections:[
    {h:null,b:"The original modern antidepressants, and the most effective. Being old and a pain in the ass keeps them from being prescribed more often. MAOIs currently available include: Emsam (selegiline transdermal system), Eldepryl (selegiline), Aurorix/Manerix (moclobemide — not available in the US), Marplan (isocarboxazid), Nardil (phenelzine sulfate), and Parnate (tranylcypromine sulfate)."},
    {h:"How They Work",b:"MAOIs create an effect similar to reuptake inhibitors, in that they slow down not the transportation mechanism, but monoamine oxidase — the chemical that breaks down the MAO class of neurotransmitters. This causes a build-up in all monoamine neurotransmitters, to varying degrees, both within and on the surface of a neuron. Just as there are different receptors for all the different neurotransmitters, there are multiple types of MAO that break them down. The most popular MAOIs on the market interfere with the action that affects the big three flavors of brain juice thought to have the most effect on depression: serotonin, norepinephrine, and dopamine. In an oversimplified way MAOIs have end results similar to reuptake inhibitors, acting like high-potency SNRIs that also work on dopamine."},
    {h:"David Foster Wallace",b:"In 2007, David Foster Wallace tapered off Nardil (phenelzine), a MAOI antidepressant he had taken since 1989, partly due to bothersome side effects and a desire to see if he could function without it. When he tried to return to the medication, it was no longer effective, leading to a severe depression and ultimately his suicide in 2008. He told a friend: It's a bit like I imagine a course of chemo would be. Within months, Wallace checked into a hospital. Although electroconvulsive therapy had damaged his memory in 1988, he went through 12 more rounds while in withdrawal, hoping to find relief. His desperation and frustration continued. Wallace reportedly rolled his eyes as doctors prescribed new pills, waiting for a different combination to work. He likened the standard trial-and-error prescriptive practice to throwing darts at a dartboard — a description that rightfully commands an understanding of what it can feel like to be a psychiatric patient: the object of chance and hope-puncturing aggression."},
    {h:null,b:"I do not know if Wallace's death could have been prevented. But the fact of his suicide, which happened during a high-risk period of withdrawal — at which time doctors initiated more high-risk treatment — raises a larger, very significant question for the mental health care system."},
  ]},
  {id:"mood-stabilizers",title:"Mood Stabilizers",subtitle:"What they are, what they are not, and why the nomenclature is a mess",
   sections:[
    {h:"What Is a Mood Stabilizer?",b:"That all depends on whom you ask. In Essential Psychopharmacology, Stahl writes that the FDA states there is no such thing as a mood stabilizer. That is not quite true. Granted, there is no mood stabilizer product subcategory in the PDR, but the old antimanic has been replaced with bipolar agents. Lamictal is approved to delay the time to occurrence of mood episodes in patients treated for acute mood episodes with standard therapy — which is about as close to mood stabilizer as you can get. Seroquel is approved to treat bipolar mania, mixed states, and bipolar depression, which about covers the entire tripolar disorder spectrum, unless someone knows of a fourth pole."},
    {h:"How PubMed Defines It",b:"Ask PubMed and you get several answers. In What makes a drug a primary mood stabilizer? the answer is mainly along the antimanic definition. In What exactly is a mood stabilizer? the answer is at least two of antimanic, antidepressant, and prophylactic properties. Using those criteria, Celexa and Lexapro are mood stabilizers, as they prevent relapses better than other SSRIs."},
    {h:"Jerod's Preferred Taxonomy",b:"A more precise taxonomy would be true mood stabilizers — Lamictal, Seroquel, lithium, and some others to a lesser extent — versus antimanics such as Depakote and Risperdal. That would be both confusing to most people, since we have all grown up on mood stabilizer equals anticonvulsant, and not entirely correct, as some primarily antimanic meds can have antidepressant qualities for some to many people. So it is difficult enough making people understand that AED and mood stabilizer are not synonyms."},
    {h:"The Bottom Line",b:"Practically every type of medication has been thrown at bipolar disorder at one time or another. Way back when bipolar was called manic-depression it seemed as if every drug in the PDR was tried. Most everyone ends up prescribed either an antiepileptic drug or an antipsychotic, usually an atypical antipsychotic, as their primary medication. Sometimes one is enough, sometimes it is part of a cocktail that includes an antidepressant, sometimes they need one or more of each. The majority of people with bipolar disorder need one or two daily meds, and their doctors get it right the first or second time. As long as you do not want perfection and keep the perspective that the side effects suck so much less than the insanely stupid things you can do when manic, let alone when you feel like shit due to this illness, you probably will not have to ride the med-go-round too often or for too long."},
  ]},
  ...
  {id:"anxiolytics",title:"Anxiolytics: Treatment Options for Anxiety",subtitle:"Using anti-anxiety drugs to treat GAD, SAnD, PTSD, OCD, PD, and other initialisms",
   sections:[
    {h:"Define Your Terms",b:"Just to clear up some of the terminology used. Anxiolytic is the technical term for an anti-anxiety medication. It is also a lot shorter. Tranquilizer and sedative are interchangeable terms for a type of anxiolytic that also puts you to sleep, or relaxes you so much you may as well be sleeping, such as a benzodiazepine. Major tranquilizer is a holdover from the days when consumers did not know shit about the meds they were taking and often refers to an antipsychotic — usually a first-generation antipsychotic — being used to treat anxiety and insomnia. Sedatives is a class of medications that includes barbiturates, chloral hydrate, benzodiazepines, and some modern hypnotics such as Ambien (zolpidem tartrate)."},
    {h:"Anxiety Spectrum Conditions",b:"When most people think of anxiety conditions they think of generalized anxiety disorder (GAD), social anxiety disorder (SAnD) / social phobia, and various panic disorders, especially agoraphobia. Other conditions in the anxiety spectrum include obsessive-compulsive disorder (OCD) and post-traumatic stress disorder (PTSD). Most of the time anxiety conditions can be treated without medication. When medication is required it is usually for a short duration and/or used as needed. As with depression, meds should be reserved for when someone is not, or is barely able to function due to their condition."},
    {h:"Do You Actually Need Meds for This?",b:"Let us take social anxiety as an example, because it is really easy to determine if you need medication for it or not. If you can leave your house, hold down a job (even one that involves as little contact with people as possible), and otherwise function, no matter how little interaction you have with anyone else, you can probably overcome the condition with therapy. Drugs, if needed, would be used for a very short time. If the only time you can leave your house is when you know there will be as few people around as possible, and you have adjusted your life so you do your shopping at 3:00 a.m. and only for stuff you cannot get online, then you need meds. Maybe not forever, but probably for more than six to eight weeks."},
    {h:null,b:"Assuming you want to leave your house in the first place. I will not go anywhere to deal with stuff like grocery shopping for two, three, sometimes four weeks at a time. Solitude has done wonders for my mental health."},
  ]},
  ...
  {id:"what-you-need",title:"What You Need to Know",subtitle:"Before and after starting any psychiatric or neurological medication - UNDER CONSTRUCTION",
   sections:[
    ...
    {h:"What to Expect",b:"No matter which meds you take, they will mess with your dreams. Other stuff will probably happen as well. See the Dealing with Common Side Effects article on this site. Also worth reading: the Meds with Fewer Side Effects article, for when your doctor gives you a choice. The differences between brand name and generic medications: brand is not necessarily better, just different. Mixing your med cocktail with actual cocktails: see the Can You Drink Alcohol article on this site."},
    {h:"Dealing with Life When You Are Crazy",b:"Planning ahead for, and making the most of, that 15-minute med check appointment: see the How to Talk to Your Doctor article on this site. Buying meds online: in 2009, 90% of ads for online pharmacies were for fraudulent websites. Not so fun fact: many of those fraudulent pharmacies used snippets from this site in their search term spamming and appeared ahead of it in Google results. Be careful. How to apply for SSDI/SSI benefits: because if you are crazy enough to be reading this site, the odds are you are too crazy to hold down a job. Sorry migraineurs, your debilitating pain still does not mean shit to the SSA."},
    {h:"Useful External Resources",b:"FDA Drug Safety pages to bookmark: Drug Recalls, Drug Shortages, Drugs to be Discontinued, Recently Reported Side Effects (also where you can report any side effect you have had that is not listed in a medication's full US PI sheet), and Recent Approvals and Changes. On Drugs.com: the Drug-Drug/Food/Disease Interaction Checker and Pill Identifier are both genuinely useful tools."},
  ]},
];
